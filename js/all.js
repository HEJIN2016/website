...
/*登录cookie设置，实现记住密码、自动登录功能*/

function setcookie(name,value,expiredays){
    var exdate = new Date();
    exdate.setDate(exdate.getDate()+expiredays);//cookie过期时间
    var expire = "expires="+exdate.toGMTString();
    document.cookie=name+"="+escape(value)+((!expiredays)?"":expire);
